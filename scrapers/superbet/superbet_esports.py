...
class SuperbetEsports:
    ...
    async def get_cs2_matches(
        ...
        return await self._get_matches_by_sport(sport_id, days_ahead, include_live)
    ...
    async def get_all_esports_matches(
        ...
        """
        tasks = {
            'cs2': self.get_cs2_matches(days_ahead, include_live),
            'dota2': self.get_dota2_matches(days_ahead, include_live),
            'valorant': self.get_valorant_matches(days_ahead, include_live),
            'lol': self.get_lol_matches(days_ahead, include_live),
        }
