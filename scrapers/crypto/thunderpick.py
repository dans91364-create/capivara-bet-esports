"""Thunderpick scraper - Disabled, awaiting API verification."""
...
class ThunderpickScraper(BaseScraper):
    """Thunderpick crypto bookmaker scraper.
    
    Status: DISABLED - Needs API/scraper verification
    
    To enable this scraper:
    1. Verify if Thunderpick has a public API
    ...
    async def health_check(self) -> bool:
        """Check if Thunderpick is accessible.
